    ...
    users: [
      {
        ...
        name: "Admin User", phone: "555-0100", createdAt: d(90),
      },
      {
        id: "user-2", email: "agent@test.com", password: "agent123", role: "agent",
        name: "Jane Smith", phone: "555-0101", createdAt: d(60),
        available: true, rating: 4.8, bio: "Experienced field agent specializing in residential inspections across the greater Chicago metro area.",
        coverageZone: "Chicago, IL", vehicle: "2022 Honda CR-V",
        totalEarnings: 2840, pendingPayout: 340, completedJobs: 47,
      },
      {
        id: "user-3", email: "agent2@test.com", password: "agent123", role: "agent",
        name: "Tom Field", phone: "555-0102", createdAt: d(55),
        available: false, rating: 4.5, bio: "Professional photographer with 5 years of real estate and insurance inspection experience.",
        coverageZone: "Springfield, IL", vehicle: "2020 Ford F-150",
        totalEarnings: 1620, pendingPayout: 180, completedJobs: 28,
      },
      {
        id: "user-4", email: "client@test.com", password: "client123", role: "client",
        name: "Bob Johnson", phone: "555-0103", company: "Johnson Realty LLC", createdAt: d(45),
      },
      {
        id: "user-5", email: "client2@test.com", password: "client123", role: "client",
        name: "Alice Brown", phone: "555-0104", company: "Midwest Property Group", createdAt: d(30),
      },
    ],
    orders: [
      {
        ...
        notes: "Please check the foundation",
        customizeNotes: "",
        photos: [],
        photoExpiresAt: null,
        createdAt: d(20),
        ...
        invoicePaid: false,
        statusHistory: [
          { status: "pending", timestamp: d(20), note: "Order submitted by client" },
        ],
      },
      {
        id: "ord-2",
        ...
        serviceType: "survey",
        turnaroundTier: "rush_24hr",
        notes: "Urgent pre-sale survey needed",
        customizeNotes: "",
        photos: [],
        photoExpiresAt: null,
        createdAt: d(16),
        offerSentAt: d(16, 10),
        offerAcceptedAt: d(16, 11),
        bulkBatchId: null,
        invoicePaid: false,
        statusHistory: [
          { status: "pending", timestamp: d(16), note: "Order submitted by client" },
          { status: "in_progress", timestamp: d(16, 14), note: "Assigned to agent Jane Smith" },
        ],
      },
      {
        id: "ord-3",
        ...
        photoExpiresAt: expire30(d(10)),
        createdAt: d(11),
        offerSentAt: d(11, 10),
        offerAcceptedAt: d(11, 11),
        bulkBatchId: null,
        invoicePaid: true,
        statusHistory: [
          { status: "pending", timestamp: d(11), note: "Order submitted by client" },
          { status: "in_progress", timestamp: d(11, 14), note: "Assigned to agent Jane Smith" },
      ...
      },
      {
        ...
        assignedAgentId: null,
        totalPrice: 350,
        compensationAmount: 228,
        serviceType: "assessment",
        turnaroundTier: "rush_6hr",
        notes: "Pre-sale full assessment",
        customizeNotes: "Please photograph the HVAC system, roof access hatch, and all structural beams visible in the basement.",
        photos: [],
        photoExpiresAt: null,
        createdAt: d(5),
        offerSentAt: d(5, 10),
        ...
        invoicePaid: false,
        statusHistory: [
          { status: "pending", timestamp: d(5), note: "Order submitted by client" },
        ],
      },
    ],
    pricingConfig: [
