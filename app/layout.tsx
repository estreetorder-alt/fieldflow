...
const BASE_URL = process.env.NEXT_PUBLIC_BASE_URL || "https://fieldflow.app";

export const metadata: Metadata = {
  metadataBase: new URL(BASE_URL),
  title: {
    default: "FieldFlow — BPO & REO Field Inspection Photography | 45+ Services",
    template: "%s | FieldFlow"
  },
  description: "FieldFlow is America's trusted BPO and REO field inspection photography platform. 45+ services including exterior photo sets, vehicle inspections, occupancy checks, and videography. Verified local agents in 35 states. Orders dispatched within seconds.",
  keywords: [
  ...
  openGraph: {
    ...
    url: BASE_URL,
    siteName: "FieldFlow",
    title: "FieldFlow — BPO & REO Field Inspection Photography | 45+ Services",
    ...
    images: [{ url: "/og-image.jpg", width: 1200, height: 630, alt: "FieldFlow — Field Inspection Platform" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "FieldFlow — BPO & REO Field Inspection Photography",
