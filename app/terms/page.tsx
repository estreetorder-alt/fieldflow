      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          {[
            ...
            { title:"11. Limitation of Liability", body:"Snapect is not liable for: inaccurate addresses provided by vendors, inability to access a property, weather or environmental conditions preventing completion, or any indirect, incidental, or consequential damages. Maximum liability is limited to the amount paid for the specific order in question." },
