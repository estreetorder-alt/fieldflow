      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto prose prose-slate">
          {[
            ...
            { title:"2. How We Use Your Information", body:"Your information is used solely to operate the Snapect platform — dispatching orders to field agents, processing payments via Stripe, delivering photos to your dashboard, and sending order status notifications. We do not use your data for advertising." },
            ...
            { title:"7. Payments", body:"Payment processing is handled by Stripe, Inc. Snapect does not store credit card numbers or payment credentials on our servers. Please review Stripe's privacy policy at stripe.com/privacy." },
            ...
            { title:"9. Your Rights", body:"You may request deletion of your account and associated data at any time by contacting support@snapect.com. Active orders cannot be deleted until completed or cancelled." },
            { title:"10. Contact", body:"For privacy-related questions, contact us at support@snapect.com. For legal matters, Snapect is a corporation registered in the State of Florida." },
          ].map(s=>(
