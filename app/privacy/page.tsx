      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto prose prose-slate">
          {[
            ...
            { title:"2. How We Use Your Information", body:"Your information is used solely to operate the FieldFlow platform — dispatching orders to field agents, processing payments via Stripe, delivering photos to your dashboard, and sending order status notifications. We do not use your data for advertising." },
            ...
            { title:"6. Photo Storage", body:"Photos uploaded by field agents are stored securely for 30 days after order completion. After 30 days, photos are permanently deleted from our servers. Clients are responsible for downloading photos within this window." },
            { title:"7. Payments", body:"Payment processing is handled by Stripe, Inc. FieldFlow does not store credit card numbers or payment credentials on our servers. Please review Stripe's privacy policy at stripe.com/privacy." },
            ...
            { title:"9. Your Rights", body:"You may request deletion of your account and associated data at any time by contacting support@fieldflow.app. Active orders cannot be deleted until completed or cancelled." },
            { title:"10. Contact", body:"For privacy-related questions, contact us at support@fieldflow.app. For legal matters, FieldFlow is a corporation registered in the State of Florida." },
          ].map(s=>(
