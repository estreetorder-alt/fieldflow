...
const CATS: Cat[] = [
  { id:"orders", label:"Orders — Placing, status & delivery", items:[
    ...
    { q:"Can I place a customized order?", a:"Yes — choose the Custom tab when placing an order and describe the exact duties you need performed (avoid vague phrases like “a typical exterior set”). Field agents will review your custom order and send offers, and you accept the offer that works for you." },
    ...
    { q:"How do I get the status of an order?", a:"Your dashboard updates in real time — each order row shows its live status: Waiting for offers → Offer accepted (with time) → Completed. When agents send offers, a badge appears on the order so you know right away. Click any address for full details, photos, and report." },
  ]},
  { id:"coverage", label:"Coverage", items:[
    ...
    { q:"What if the nearest agent is far from my property?", a:"Field agents typically accept orders within about 7 miles of their location. For remote or rural properties, agents factor travel into their offers, so offers on those orders may take slightly longer to arrive." },
  ]},
