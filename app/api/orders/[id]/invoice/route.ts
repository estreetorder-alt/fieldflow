...
<div class="page">
  <div class="header">
    <div class="brand">Snapect <span>Velocity REOs Field Services</span></div>
  ...
  <div class="body">
    ...
    <div style="padding:16px;border:1px solid #e2e8f0;border-radius:8px">
      <p style="font-size:12px;color:#64748b;line-height:1.7">
        This invoice is generated by Snapect (Velocity REOs, Inc.). 
  ...
  <div class="footer">
    <p>Snapect · fieldflow.com · (941) 723-3200</p>
